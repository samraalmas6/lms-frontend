...
const Sidebar = () => {
  return (
    <div
      ...
      role="navigation"
    >
      <ul className="nav flex-column sticky-top pl-0 pt-0 p-2 mt-3 sidebar-nav">
        ...
        <li className="nav-item mb-2 ">
          ...
          <ul className="list-unstyled flex-column pl-3 collapse sidebar-nav-sub" id="submenu3">
      ...
      {/*  Chats and notification section will be developed in future  */}
        ...
        <li className="nav-item mb-2 ">
          ...
          <ul className="list-unstyled flex-column pl-3 collapse sidebar-nav-sub" id="submenu5">
            <li className="nav-item mb-2 ">
              <a className="nav-link text-secondary" href="">
               Accounts
              </a>
